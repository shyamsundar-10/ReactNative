  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.title}>
        <Text style={{ color: "black", fontSize: 24 }}>Shop By Brand</Text>
      </View>
      <View style={styles.row1}>
        <View>
          <TouchableHighlight onPress={() => handleBrandPress("apple")}>
            <Image
        ...
        <View>
          <TouchableHighlight onPress={() => handleBrandPress("samsung")}>
            <Image
      ...
      <View style={styles.row2}>
        <View>
          <TouchableHighlight onPress={() => handleBrandPress("xiaomi")}>
            <Image
        ...
        <View>
          <TouchableHighlight onPress={() => handleBrandPress("realme")}>
            <Image
